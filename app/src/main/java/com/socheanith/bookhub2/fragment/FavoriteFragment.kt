...
import com.socheanith.bookhub2.adapter.FavoriteRecycleAdaptor
...
class FavoriteFragment : Fragment() {
    ...
    lateinit var recyclerAdator: FavoriteRecycleAdaptor
    ...
    override fun onCreateView(
        ...
        if(activity != null){
            ...
            recyclerAdator = FavoriteRecycleAdaptor(activity as Context, dbBookList)
            recyclerFavorite.adapter = recyclerAdator
